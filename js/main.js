...
let renderGlass = () => {
  ...
  //   html += `
  //           <div class="col-4 vglasses__items" onclick="glassOn('${glass.id}')"><img src="${glass.src}" alt="..." class="img-fluid"></div>
  //       `;
  ...
  //   html += `
  //           <div class="col-4 vglasses__items" onclick="glassOn('${dataGlasses[i].id}')"><img src="${dataGlasses[i].src}" alt="..." class="img-fluid"></div>
  //       `;
  // }
  // document.querySelector("#vglassesList").innerHTML = html;
};
